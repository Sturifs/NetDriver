    ...
    <section id="planes" style={{ background: '#f8fafc', padding: '72px 40px', color: '#0f172a' }}>
      <div style={{ textAlign: 'center', marginBottom: '32px' }}>
        ...
        <div style={{ display: 'inline-flex', background: '#e2e8f0', borderRadius: '8px', padding: '4px' }}>
          <button onClick={() => setActivePlan('conductor')} style={{ padding: '9px 28px', borderRadius: '6px', border: 'none', background: activePlan === 'conductor' ? '#1e3a5f' : 'transparent', color: activePlan === 'conductor' ? 'white' : '#94a3b8', fontWeight: 700, fontSize: '0.88rem', cursor: 'pointer' }}>CONDUCTOR</button>
...
{activePlan === 'empresa' && (
  <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px', maxWidth: '820px', margin: '0 auto' }}>
    <div style={{ background: '#0d1f3c', borderRadius: '16px', padding: '30px', border: '1px solid rgba(34,197,94,0.2)' }}>
      ...
      <button onClick={() => openModal('conductor')} style={{ width: '100%', padding: '13px', borderRadius: '9px', border: 'none', background: '#2563eb', color: 'white', fontWeight: 700, cursor: 'pointer', fontSize: '0.95rem' }}>💬 Contáctanos para realizar una cotización</button>
    </div>
  </div>
)}
    </section>
