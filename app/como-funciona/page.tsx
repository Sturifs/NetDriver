...
export default function ComoFunciona() {
  ...
  const Card = ({ num, icon, title, desc, highlight }: { num: number, icon: string, title: string, desc: string, highlight?: string }) => (
    <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '14px', padding: '24px 18px 20px', position: 'relative', display: 'flex', flexDirection: 'column', gap: '8px', height: '100%' }}>
  ...
  return (
    <>
      ...
      <div style={{ background: '#020D24', minHeight: '100vh', color: 'white', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
        ...
        {/* NAVBAR */}
        <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 40px 0 0', height: '85px', marginLeft: '-12px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: '#020D24', zIndex: 100 }}>
        ...
        <div style={{ position: 'relative', background: "url('/camion2_como_funciona.png') top right / 42% auto no-repeat", padding: '80px 40px 60px' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1100px', margin: '0 auto' }}>
          ...
          {tab === 'conductor' && (
            <div>
              ...
              {/* BANNER */}
              <div style={{ background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: '14px', padding: '28px 36px', display: 'flex', alignItems: 'center', gap: '24px', marginBottom: '56px', marginTop: '80px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '20px', marginBottom: '56px' }}>
                {[
                  ...
                  <div key={item.title} style={{ textAlign: 'center', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', padding: '24px 16px', border: '1px solid rgba(255,255,255,0.07)' }}>
          ...
          {tab === 'empresa' && (
            <div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', alignItems: 'center', marginBottom: '56px' }}>
                ...
                <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: '16px', padding: '24px', border: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', margin: '16px 0' }}>
                <div style={{ background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: '12px', padding: '16px 32px', display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          {/* STATS */}
          <div style={{ display: 'flex', justifyContent: 'center', gap: '56px', flexWrap: 'wrap', marginTop: '72px', paddingTop: '48px', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
